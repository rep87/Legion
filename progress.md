...
- 2026-03-09: `Base Command`를 좌측에서 제거하고 캔버스 우측 컬럼 상단으로 이동.
- 2026-03-09: `robots.js` 마운트 지점을 우측 전용 `#robot-layout`으로 변경하고 `Fabricator | Path Slots / Disassembly / Active Robots` 2열 레이아웃으로 분리.
